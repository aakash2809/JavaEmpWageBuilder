...
public class EmpWageBuilder {
	...
	// FUNCTION TO GIVE RESULT HOW MANY HOURS HE WORKS BASED ON RANDOM KEY FOR HALF
	// DAY OR FULL DAY
	...
	public void computeEmpWage() {
		...
		while (workigDaysCompleted < Working_DAYS_PER_MONTH && workigHoursCompleted < WORKING_HOURS_PER_MONTH) {
			...
			if (empAttandanceStatus == EMPLOYEE_STATUS) {
				...
				numberOfPresent++;
				int empDayStatus = (int) (Math.floor(Math.random() * 10) % 2); // KEY GENRATION FOR HALF DAYS AND FULL
																				// DAYS
